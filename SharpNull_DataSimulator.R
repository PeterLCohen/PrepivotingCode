...
# The constant additive treatment effect (for each of the outcomes)
#   When set to 0 Fisher's sharp null holds
...
for(i in 1:nrand)
{
  ...
  for(k in 1:K)
  {
    Yt[,k] = Yttemp[,k] - mean(Yttemp[,k] - Yc[,k]) + tau
  }
...
# To save results
filename = paste('Power_multN300sharp_tau', tau, sep ="")
